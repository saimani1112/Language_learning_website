...
include("config.php");
// Insert operation
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit_insert_quiz"])) {
    $QuizID = $_POST["quiz_id"];
    $languageID = $_POST["language_id"];
    $question = $_POST["question"];
    $answer = $_POST["answer"];

    $sql = "INSERT INTO Quiz (quiz_id, language_id , question, answer) VALUES ('$QuizID','$languageID', '$question', '$answer')";
...
// Delete operation
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit_delete_quiz"])) {
    $quizIDToDelete = $_POST["quiz_id_to_delete"];

    $sql = "DELETE FROM Quiz WHERE quiz_id = '$quizIDToDelete'";
...
// Update operation
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit_update_quiz"])) {
    ...
    $sql = "UPDATE Quiz SET language_id = '$newLanguageID', question = '$newQuestion', answer = '$newAnswer' WHERE quiz_id = '$quizIDToUpdate'";
...
?>
    ...
    <div class="container">
        ...
        <form method="post" action="">
            ...
            <input type="submit" name="submit_insert_quiz" value="Insert">
        </form>
        ...
        <form method="post" action="">
            ...
            <input type="submit" name="submit_delete_quiz" value="Delete">
        </form>
        ...
        <form method="post" action="">
            ...
            <input type="submit" name="submit_update_quiz" value="Update">
        </form>
        ...
        <table>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='4'>No quiz questions found</td></tr>";
            }
            ?>
        </table>
    </div>
