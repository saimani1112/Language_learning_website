                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <a href=""><h5 class="mb-3">Quiz</h5></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <a href="Quiz1.php"><h5 class="mb-3">Quiz Score</h5></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
...
// If the user has selected languages, fetch frequently used words for each language
if ($userLanguagesResult->num_rows > 0) {
    ...
    <div class="container">
        ...
        while ($userLanguage = $userLanguagesResult->fetch_assoc()) {
            ...
            $frequentlyUsedWordsQuery = "SELECT * FROM frequently_used_words WHERE language_id = '$userLanguageID'";
            $frequentlyUsedWordsResult = $conn->query($frequentlyUsedWordsQuery);

            echo "<h2>{$userLanguageName}</h2>";

            // Display frequently used words table for the current language
            if ($frequentlyUsedWordsResult->num_rows > 0) {
                echo "<table>";
                echo "<tr><th>Words in Language</th><th>English Meaning</th></tr>";
                while ($row = $frequentlyUsedWordsResult->fetch_assoc()) {
                    echo "<tr>";
                ...
                echo "<p>No frequently used words found for {$userLanguageName}</p>";
            }
        }
        ?>
