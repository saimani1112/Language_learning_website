...
// Insert operation
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit_insert_food"])) {
    $quizID = $_POST["quiz_id"];
    $languageID = $_POST["language_id"];
    $wordsInLang = $_POST["words_in_language"];
    $englishMeaning = $_POST["english_meaning"];

    $sql = "INSERT INTO food (quiz_id, language_id, words_in_language, english_meaning) 
...
// Delete operation
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit_delete_food"])) {
    $quizIDToDelete = $_POST["quiz_id_to_delete"];

    $sql = "DELETE FROM food WHERE quiz_id = '$quizIDToDelete'";
...
// Update operation
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit_update_food"])) {
...
<div class="container">
    ...
    <form method="post" action="">
        ...
        <input type="submit" name="submit_insert_food" value="Insert">
    </form>
    ...
    <form method="post" action="">
        ...
        <input type="submit" name="submit_delete_food" value="Delete">
    </form>
    ...
    <form method="post" action="">
        ...
        <input type="submit" name="submit_update_food" value="Update">
    </form>
