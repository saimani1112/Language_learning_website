    ...
    <div class="container">
        ...
        <?php if ($userInfo) : ?>
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                ...
                <input type="text" id="newFirstName" name="newFirstName" value="<?php echo $userInfo['firstname']; ?>"><br>

                <label for="newLastName">New Last Name:</label>
                <input type="text" id="newLastName" name="newLastName" value="<?php echo $userInfo['lastname']; ?>"><br>

                <label for="newEmail">New Email:</label>
                <input type="email" id="newEmail" name="newEmail" value="<?php echo $userInfo['email']; ?>"><br>

                <label for="newPassword">New Password:</label>
                <input type="password" id="newPassword" name="newPassword" value="<?php echo $userInfo['password']; ?>"><br>
